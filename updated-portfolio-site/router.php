...
set_exception_handler(function ($ex) {
  ...
  ?>
  <html>
      <?php include("glu3-project1/includes/meta"); ?>
      <body>
          <?php include("glu3-project1/includes/header.php:); ?>
          <main>
          <h2>Sorry! Something went wrong on the server.</h2>
          <p>Please email pugandpeonystudios@gmail.com if you need further assistance. Alternatively go to the "Contact Me" form on the <a href="/pages/faqpage.php">FAQ Page</a> to send a help request!</p>
          </main>
...
const ROUTES = array(
  '/' => 'pages/index.php',
  '/about-me' => 'pages/aboutme.php',
  '/about-me/newsletter-confirmation' => 'pages/newsletter-confirmation.php',
  '/faq' => 'pages/faqpage.php',
  '/faq/contact-me-confirmation'=> 'pages/contact-confirmation.php',
  '/support-me' => 'pages/supportme.php',
  '/support-me/commission-confirmation'=> 'pages/commission-confirmation.php',
  '/page-not-found' => 'pages/resourcenotfound.php'
);
...
if ($php_file = match_routes($request_uri, ROUTES)) {
  ...
  <html>
      ...
      <body>
          <?php include("glu3-project1/includes/header.php"); ?>
          <main>
          <h2>Sorry! It seems that the page you are trying to reach does not exist.</h2>
          <p>Please email pugandpeonystudios@gmail.com if you need further assistance. Alternatively go to the "Contact Me" form on the <a href="/pages/faqpage.php">FAQ Page</a> to send a help request!</p>
          </main>
          <?php include("glu3-project1/includes/footer.php"); ?>
      </body>
